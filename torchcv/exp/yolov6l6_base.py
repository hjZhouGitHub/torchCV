...
class Exp(BaseExp):
    ...
    def get_model(self):
        from torchcv.models import YOLOX, YOLOPAFPN, YOLOXHead
    ...
    def get_dataset(self, cache: bool = False, cache_type: str = "ram"):
        ...
        """
        from torchcv.data import COCODataset, TrainTransform
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False, cache_img: str = None):
        ...
        from torchcv.utils import wait_for_the_master
    ...
    def get_lr_scheduler(self, lr, iters_per_epoch):
        from torchcv.utils import LRScheduler
    ...
    def get_eval_dataset(self, **kwargs):
        from torchcv.data import COCODataset, ValTransform
    ...
    def get_trainer(self, args):
        from torchcv.core import Trainer
